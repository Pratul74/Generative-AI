...
st.set_page_config(page_title="Smartphone Spec Extractor", page_icon="📱")
...
description = st.text_area(
    "Enter the smartphone description",
    height=250,
    placeholder="Paste the smartphone description here..."
)

if st.button("Extract Specifications"):
    if description.strip():
        final_prompt = prompt.invoke({"description": description})
        ...
        st.warning("Please enter a smartphone description.")